...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2024 at 04:06 PM
...
(2, 0, 4, 'C0005', 'P0004', 'Es Sarang Burung', 2, 400000),
(3, 5, 0, 'C0005', 'P0002', 'Es Krim (Termos)', 2, 375000);
...
--
-- Dumping data for table `maksimal_pemesanan`
--
...
--
-- Dumping data for table `varian_rasa_produk`
--
...
--
-- Dumping data for table `varian_ukuran_produk`
--
...
--
-- Indexes for table `maksimal_pemesanan`
--
ALTER TABLE `maksimal_pemesanan`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `opsi_produk`
--
ALTER TABLE `opsi_produk`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `varian_rasa_produk`
--
ALTER TABLE `varian_rasa_produk`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `varian_ukuran_produk`
--
ALTER TABLE `varian_ukuran_produk`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `maksimal_pemesanan`
--
ALTER TABLE `maksimal_pemesanan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `opsi_produk`
--
ALTER TABLE `opsi_produk`
...
--
-- AUTO_INCREMENT for table `varian_rasa_produk`
--
ALTER TABLE `varian_rasa_produk`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `varian_ukuran_produk`
--
ALTER TABLE `varian_ukuran_produk`
...
--
ALTER TABLE `kota`
  ADD CONSTRAINT `fk_province` FOREIGN KEY (`province_id`) REFERENCES `provinsi` (`id`);
COMMIT;
